...
const getAllInventory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const inventory = yield product_service_1.default.getAllInventory();
...
const getInventoryById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const inventoryItem = yield product_service_1.default.getInventoryById(productId);
        if (inventoryItem) {
...
const addNewInventoryItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const createdInventoryItem = yield product_service_1.default.addNewInventoryItem(newInventoryItemData);
...
const updateInventoryItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const updatedInventoryItem = yield product_service_1.default.updateInventoryItem(productId, updatedInventoryItemData);
...
const deleteInventoryItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const productId = req.params.productId;
    try {
        const deletedInventoryItem = yield product_service_1.default.deleteInventoryItem(productId);
