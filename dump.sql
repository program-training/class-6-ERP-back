...
VALUES
  (46, true, 400, 'Supplier A'),
  (47, true, 600, 'Supplier B'),
  (48, true, 1000, 'Supplier C'),
  (49, true, 200, 'Supplier D'),
  (50, true, 350, 'Supplier E'),
  (51, true, 1500, 'Supplier F'),
  (52, true, 1200, 'Supplier G'),
  (53, true, 1200, 'Supplier H'),
  (54, true, 900, 'Supplier I'),
  (55, true, 900, 'Supplier J'),
  (56, true, 10, 'Supplier K'),
  (57, true, 25, 'Supplier L'),
  (58, true, 10, 'Supplier M'),
  (59, true, 80, 'Supplier N'),
  (60, true, 20, 'Supplier O'),
  (61, true, 15, 'Supplier P'),
  (62, true, 8, 'Supplier Q'),
  (63, true, 30, 'Supplier R'),
  (64, true, 35, 'Supplier S'),
  (65, true, 60, 'Supplier T'),
  (66, true, 5, 'Supplier U'),
  (67, true, 3, 'Supplier V'),
  (68, true, 5, 'Supplier W'),
  (69, true, 35, 'Supplier X'),
  (70, true, 25, 'Supplier Y'),
  (71, true, 20, 'Supplier Z'),
  (72, true, 15, 'Supplier AA'),
  (73, true, 25, 'Supplier BB'),
  (74, true, 50, 'Supplier CC'),
  (75, true, 15, 'Supplier DD');
