...
VALUES
  (85, true, 400, 'Supplier A'),
  (86, true, 600, 'Supplier B'),
  (87, true, 1000, 'Supplier C'),
  (88, true, 200, 'Supplier D'),
  (89, true, 350, 'Supplier E'),
  (90, true, 1500, 'Supplier F'),
  (91, true, 1200, 'Supplier G'),
  (92, true, 1200, 'Supplier H'),
  (93, true, 900, 'Supplier I'),
  (94, true, 900, 'Supplier J'),
  (95, true, 10, 'Supplier K'),
  (96, true, 25, 'Supplier L'),
  (97, true, 10, 'Supplier M'),
  (98, true, 80, 'Supplier N'),
  (99, true, 20, 'Supplier O'),
  (100, true, 15, 'Supplier P'),
  (101, true, 8, 'Supplier Q'),
  (102, true, 30, 'Supplier R'),
  (103, true, 35, 'Supplier S'),
  (104, true, 60, 'Supplier T'),
  (105, true, 5, 'Supplier U'),
  (106, true, 3, 'Supplier V'),
  (107, true, 5, 'Supplier W'),
  (108, true, 35, 'Supplier X'),
  (109, true, 25, 'Supplier Y'),
  (110, true, 20, 'Supplier Z'),
  (111, true, 15, 'Supplier AA'),
  (112, true, 25, 'Supplier BB'),
  (113, true, 50, 'Supplier CC'),
  (114, true, 15, 'Supplier DD');
